...
public class ManageSuppliersJPanel extends javax.swing.JPanel {
    ...
    private void btnAddSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddSupplierActionPerformed
        ...
        AddSupplierJPanel addSupplierjp = new AddSupplierJPanel(userProcessContainer, supplierDirectory);
        userProcessContainer.add("AddSupplier", addSupplierjp);
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        ViewSupplierJPanel vs = new ViewSupplierJPanel(userProcessContainer, supplier);
