...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageProductCatalogJPanel(JPanel workArea, Supplier supplier, SupplierDirectory supplierDirectory) {
        initComponents();
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        ViewProductDetailJPanel vpdjp = new ViewProductDetailJPanel(workArea, selectedProduct,supplierDirectory);
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        CreateNewProductJPanel newproductjp = new CreateNewProductJPanel(workArea, supplier);
        workArea.add("SupplierWorkAreaJPanel", newproductjp);
        CardLayout layout = (CardLayout) workArea.getLayout();
        layout.next(workArea);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        // TODO add your handling code here:
        SearchForProductJPanel searchproductjp = new SearchForProductJPanel(workArea, supplier, supplierDirectory);
        workArea.add("SearchForProductJPanel",searchproductjp);
        CardLayout layout = (CardLayout) workArea.getLayout();
        layout.next(workArea);
