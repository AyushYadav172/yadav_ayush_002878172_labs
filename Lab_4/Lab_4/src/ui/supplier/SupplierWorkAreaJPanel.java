...
//      masterOrderCatalog = moc;
    ...
    private void btnManageProductCatalogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageProductCatalogActionPerformed
        ...
        ManageProductCatalogJPanel productcatalogjp = new ManageProductCatalogJPanel(workArea, supplier, supplierDirectory);
        workArea.add("ManageProductCatalogJPanel", productcatalogjp);
...
//        layout.next(userProcessContainer);
    ...
    private void btnSupplierProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSupplierProfileActionPerformed
        ...
        SupplierProfileJPanel supplierprofilejp = new SupplierProfileJPanel(workArea, supplier);
        workArea.add("ManageProductCatalogJPanel", supplierprofilejp);
        CardLayout layout = (CardLayout) workArea.getLayout();
        layout.next(workArea);
